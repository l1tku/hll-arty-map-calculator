...
H4: { 
  ...
  HUR: {
    ...
    strongpoints: [
      ...
      // --- ALLIES GUNS ---
      { label: "", id: "US_A3", gameX: -92088.86, gameY: 4955.032, radius: 500, team: "us", type: "point", rotation: -95.6 },
      { label: "", id: "US_A2", gameX: -93577.97, gameY: 3982.9868, radius: 500, team: "us", type: "point", rotation: -99.7 },
      { label: "", id: "US_A1", gameX: -92188.766, gameY: 2897.9956, radius: 500, team: "us", type: "point", rotation: -98.4 },

      // --- AXIS GUNS ---
      { label: "", id: "GER_A3", gameX: 91198.0, gameY: -10428.0, radius: 500, team: "ger", type: "point", rotation: 90.0 },
      { label: "", id: "GER_A2", gameX: 91198.0, gameY: -11227.0, radius: 500, team: "ger", type: "point", rotation: 90.0 },
      { label: "", id: "GER_A1", gameX: 91198.0, gameY: -11963.0, radius: 500, team: "ger", type: "point", rotation: 90.0 },
...
KUR: {
    ...
    strongpoints: [
      ...
      // --- ALLIES GUNS ---
      { label: "", id: "SOV_A1", gameX: 3988.0, gameY: 91604.0, radius: 500, team: "us", type: "point", rotation: 0.0 },
      { label: "", id: "SOV_A2", gameX: 4834.0, gameY: 91543.0, radius: 500, team: "us", type: "point", rotation: 0.0 },
      { label: "", id: "SOV_A3", gameX: 5641.0, gameY: 91341.0, radius: 500, team: "us", type: "point", rotation: 0.0 },

      // --- AXIS GUNS ---
      { label: "", id: "GER_A1", gameX: -1583.09, gameY: -91085.52, radius: 500, team: "ger", type: "point", rotation: 164.8 },
  ...
  OMA: {
    ...
    strongpoints: [
      ...
      // --- ALLIES GUNS ---
      { label: "", id: "US_A1", gameX: 77848.13, gameY: -6830.192, radius: 500, team: "us", type: "point", rotation: 87.2 },
      { label: "", id: "US_A2", gameX: 78467.6, gameY: -9514.723, radius: 500, team: "us", type: "point", rotation: 87.2 },
      { label: "", id: "US_A3", gameX: 79327.93, gameY: -3703.3025, radius: 500, team: "us", type: "point", rotation: 92.8 },

       // --- AXIS GUNS ---
      { label: "", id: "GER_A1", gameX: -93808.164, gameY: -1728.4452, radius: 500, team: "ger", type: "point", rotation: -89.5 },
...
SMM: {
    ...
    strongpoints: [
      ...
      { label: "", id: "GER_A3", gameX: -1324.40, gameY: -95453.88, radius: 500, team: "ger", type: "point", rotation: -180.0 },
...
STA: { 
  ...
  TOB: {
    ...
    strongpoints: [
      ...
      // --- ALLIES GUNS ---
      { label: "", id: "GB_A3", gameX: 93126.9, gameY: 7690.272, radius: 500, team: "us", type: "point", rotation: 114.4 },
      { label: "", id: "GB_A2", gameX: 92639.85, gameY: 5926.3613, radius: 500, team: "us", type: "point", rotation: 87.8 },
      { label: "", id: "GB_A1", gameX: 93045.516, gameY: 1597.4238, radius: 500, team: "us", type: "point", rotation: 61.6 },

      // --- AXIS GUNS ---
      { label: "", id: "GER_A3", gameX: -92423.66, gameY: -5152.503, radius: 500, team: "ger", type: "point", rotation: -109.7 },
      { label: "", id: "GER_A2", gameX: -93282.37, gameY: -5983.347, radius: 500, team: "ger", type: "point", rotation: -90.0 },
      { label: "", id: "GER_A1", gameX: -92338.164, gameY: -7535.631, radius: 500, team: "ger", type: "point", rotation: -78.7 },
...
UTA: { 
    ...
    strongpoints: [
      ...
      // --- ALLIES GUNS ---
      { label: "", id: "US_A1", gameX: 77788.36, gameY: -6617.35, radius: 500, team: "us", type: "point", rotation: 87.2 },
      { label: "", id: "US_A2", gameX: 78334.16, gameY: -4627.70, radius: 500, team: "us", type: "point", rotation: 92.8 },
      { label: "", id: "US_A3", gameX: 77932.25, gameY: -2639.21, radius: 500, team: "us", type: "point", rotation: 92.8 },

      // --- AXIS GUNS ---
      { label: "", id: "GER_A1", gameX: -91738.08, gameY: -221.04, radius: 500, team: "ger", type: "point", rotation: -89.5 },
      { label: "", id: "GER_A2", gameX: -91714.0, gameY: 752.0, radius: 500, team: "ger", type: "point", rotation: -89.5 },
      { label: "", id: "GER_A3", gameX: -91649.22, gameY: 1828.61, radius: 500, team: "ger", type: "point", rotation: -89.5 },
